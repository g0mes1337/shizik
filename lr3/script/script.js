window.onload=()=>{
    ...
    go.onclick=()=>{
        ...
        form.insertAdjacentHTML("beforeend","<div class='form-title'>Сколько времени в день вы проводите в дороге?</div><div class='inputs'><label for=''><input type='radio' value='1' placeholder='' checked name='one'>До 1 часа</label><label for=''><input type='radio' value='1' placeholder='' name='one'>1-2 часа</label><label for=''><input type='radio' value='1' placeholder='' name='one'>2-4 часа</label><label for=''><input type='radio' value='1' placeholder='' name='one'>Более 4 часов</label></div><button class=\"btn \" id='next'><span>Следующий вопрос</span></button>");
        let i = 1;
        ...
        function change(e) {
            ...
            switch (i) {
                case 1:
                    ...
                    break;
                case 2:
                    form.insertAdjacentHTML("beforeend","<div class='form-title'>Что для вас самое главное в личном водителе?</div><div class='inputs'><label for=''><input type='radio' value='1' placeholder='' checked name='one'>Пунктуальность</label><label for=''><input type='radio' value='1' placeholder='' name='one'>Умение поддержать беседу</label><label for=''><input type='radio' value='1' placeholder='' name='one'>Образованность и такт</label><label for=''><input type='radio' value='1' placeholder='' name='one'>Отсутствие вредных привычек</label></div><button class=\"btn \" id='next'><span>Следующий вопрос</span></button>");
                    button = document.getElementById('next');
                    button.onclick = change;
                    i++;
                    break;
